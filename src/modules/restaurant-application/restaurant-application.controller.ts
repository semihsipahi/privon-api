...
import {
  ...
  ApprovalResult,
} from './restaurant-application.service';
...
export class RestaurantApplicationController {
  constructor(
    private readonly restaurantApplicationService: RestaurantApplicationService,
  ) {}
  ...
  updateStatus(
    ...
    return this.restaurantApplicationService.updateStatus(
      id,
